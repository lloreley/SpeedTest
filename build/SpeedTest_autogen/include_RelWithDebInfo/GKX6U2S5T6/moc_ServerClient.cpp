...
QT_MOC_LITERAL(6, 64, 12), // "sendToServer"
QT_MOC_LITERAL(7, 77, 3), // "str"
QT_MOC_LITERAL(8, 81, 14), // "processMessage"
QT_MOC_LITERAL(9, 96, 18), // "tryConnectToServer"
QT_MOC_LITERAL(10, 115, 15), // "checkConnection"
QT_MOC_LITERAL(11, 131, 4) // "read"

    },
    "ServerClient\0messageReceived\0\0message\0"
    "connectionLost\0disconnect\0sendToServer\0"
...
void ServerClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ServerClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerClient::disconnect)) {
                *result = 2;
                return;
            }
        }
