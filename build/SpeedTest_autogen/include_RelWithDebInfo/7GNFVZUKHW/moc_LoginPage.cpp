/****************************************************************************
** Meta object code from reading C++ file 'LoginPage.hpp'
**
...
#include <memory>
#include "../../../../include/Pages/LoginPage/LoginPage.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'LoginPage.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 14), // "dontUseAccount"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 16) // "isSuccessfulSign"

    },
    "LoginPage\0dontUseAccount\0\0isSuccessfulSign"
};
...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dontUseAccount(); break;
        case 1: _t->isSuccessfulSign(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
