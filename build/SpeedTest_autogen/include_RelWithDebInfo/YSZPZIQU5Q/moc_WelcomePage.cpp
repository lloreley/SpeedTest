...
#include <memory>
#include "../../../../include/Pages/WelcomePage/WelcomePage.hpp"
...
void WelcomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomePage::TypingTest)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (WelcomePage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomePage::TypingLessons)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WelcomePage::TypingTest()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void WelcomePage::TypingLessons()
{
