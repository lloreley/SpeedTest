...
#include <memory>
#include "../../../../include/ServerClient.hpp"
...
QT_MOC_LITERAL(5, 53, 18), // "connectionIsActive"
QT_MOC_LITERAL(6, 72, 12), // "sendToServer"
QT_MOC_LITERAL(7, 85, 3), // "str"
QT_MOC_LITERAL(8, 89, 18), // "tryConnectToServer"
QT_MOC_LITERAL(9, 108, 15), // "checkConnection"
QT_MOC_LITERAL(10, 124, 14), // "processMessage"
QT_MOC_LITERAL(11, 139, 4) // "read"
...
void ServerClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ServerClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerClient::connectionIsActive)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void ServerClient::connectionIsActive()
{
