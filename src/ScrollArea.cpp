...
void ScrollArea::showRepeatTypingTestPage()
{
    try
    {
...
void ScrollArea::showTypingLessonsPage()
{
    try
    {
...
void ScrollArea::showAccountPage()
{
    try
    {
